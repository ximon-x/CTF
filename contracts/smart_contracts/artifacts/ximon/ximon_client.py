...
class SumArgs(_ArgsBase[int]):
    ...
    @staticmethod
    def method() -> str:
        return "sum(uint64,uint64)uint64"


@dataclasses.dataclass(kw_only=True)
class CallAuthorizeArgs(_ArgsBase[None]):
    @staticmethod
    def method() -> str:
        return "call_authorize()void"
...
class GlobalState:
    def __init__(self, data: dict[bytes, bytes | int]):
        self.access = ByteReader(typing.cast(bytes, data.get(b"access")))
...
class Composer:
    ...
    def sum(
        ...
        *,
        ...
        """Adds a call to `sum(uint64,uint64)uint64` ABI method
    ...
    def call_authorize(
        ...
        *,
        ...
        """Adds a call to `call_authorize()void` ABI method
        
        :param algokit_utils.TransactionParameters transaction_parameters: (optional) Additional transaction parameters
        :returns Composer: This Composer instance"""

        args = CallAuthorizeArgs()
        self.app_client.compose_call(
            self.atc,
            call_abi_method=args.method(),
            transaction_parameters=_convert_call_transaction_parameters(transaction_parameters),
...
class XimonClient:
    """A class for interacting with the Ximon app providing high productivity and
    ...
    def __init__(
        ...
        *,
        ...
        """
        XimonClient can be created with an app_id to interact with an existing application, alternatively
    ...
    def sum(
        ...
        *,
        ...
        """Calls `sum(uint64,uint64)uint64` ABI method
    ...
    def call_authorize(
        ...
        *,
        ...
        """Calls `call_authorize()void` ABI method
